...
{
    public partial class FormCTHDNhapVT : Form
    {
        FormMain frmMain;
        string[] str_dsvt;
        DSVatTu dsvt;
        ...
        public FormCTHDNhapVT(FormMain frm)
        {
            frmMain = frm;
            InitializeComponent();
            refreshDataGVDSVT();
...
//Kiểm tra xem nút tiếp tục có được nhấn hay không không thì xóa hóa đơn đã lập
        private void FormCTHDNhapVT_FormClosing(object sender, FormClosingEventArgs e)
        {
...
//Nhập vật tư - Thay đổi SLTon hoặc tạo một VT mới
        private void btnNhapHang_Click(object sender, EventArgs e)
        {
            if (txtMaVT.Text == "" || txtTenVT.Text == "" || txtDVT.Text == ""
                || txtTenVT.Text == " " || txtDVT.Text == " "
                || txtSLNhap.Text == "" || txtDonGia.Text == "" || txtVAT.Text == ""
            ...
            else
            {
                int slnhap;
                double vat;
                if (!int.TryParse(txtSLNhap.Text, out slnhap) || !double.TryParse(txtVAT.Text, out vat) || !int.TryParse(txtDonGia.Text, out _))
                {
                    if (!int.TryParse(txtSLNhap.Text, out slnhap))
                        pnlSLNhap.BackColor = Color.Red;
                ...
                else
                {
                    ...
                    {
                        dsvt.timVatTuDeNhap(dsvt.root, txtMaVT.Text, slnhap);
                    }
                    else
                    {
                        VatTu vt = new VatTu(txtMaVT.Text, txtTenVT.Text, txtDVT.Text, slnhap);
                    ...
                    CTHoaDon cthd = new CTHoaDon(txtMaVT.Text, slnhap, txtDonGia.Text, vat);
        ...
        private void btnXoaVT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (pos != -1 && pos2 != -1)
                {
                    ...
                    dsvt.timVatTuDeXuat(dsvt.root, txtXoaMaVT.Text, p.Cthd.Soluong);
...
//Tiếp tục tới form FormNVLapHD
        ...
        private void dataGViewDSVT_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (index != -1)
            {
                ...
                pnlSLNhap.BackColor = Color.Transparent;
            }
        }
        ...
        private void txtMaVT_Click(object sender, EventArgs e)
        {
            pnlMaVT.BackColor= Color.Transparent;
        }
        ...
        private void txtSLNhap_Click(object sender, EventArgs e)
        {
            pnlSLNhap.BackColor = Color.Transparent;
        }
        ...
        {
            pnlDonGia.BackColor = Color.Transparent;
        }

        private void txtVAT_Click(object sender, EventArgs e)
        {
            pnlVAT.BackColor = Color.Transparent;
        }

        private void txtXoaMaVT_Click(object sender, EventArgs e)
        {
            pnlXoaMaVT.BackColor = Color.Transparent;
        }
